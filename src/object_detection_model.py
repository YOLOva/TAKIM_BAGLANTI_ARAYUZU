...
class ObjectDetectionModel:
    ...
    def __init__(self, evaluation_server_url):
        ...
        self.model = AutoDetectionModel.from_pretrained(
            model_type='yolov5',
            model_path=r"src\yolova\models\best.pt",
    ...
    def detect(self, prediction, image_path):
        ...
        for coco in cocos:
            ...
            if (self.confidences[cls[0]] > score):
                # Tahmin edilen nesnenin sınıfı classes sözlüğü kullanılarak atanmalıdır.
                continue
            bbox = coco["bbox"]
            # Tahmin edilen nesnenin inilebilir durumu landing_statuses sözlüğü kullanılarak atanmalıdır.
        ...
        d_objs = self.inisAlaniKontrolu(
            detection_inis_group, detection_diger_group)
